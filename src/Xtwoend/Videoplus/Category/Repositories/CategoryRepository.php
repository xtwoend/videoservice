<?php namespace Xtwoend\Videoplus\Category\Repositories;
...
use Xtwoend\Videoplus\Category\CategoryInterface;

class CategoryRepository extends AbstractRepository implements CategoryInterface , AbstractRepositoryInterface {
