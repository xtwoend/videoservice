<?php namespace Xtwoend\Videoplus\OnDemand\Repositories;
...
use Xtwoend\Videoplus\OnDemand\OnDemandInterface;

class OnDemandRepository extends AbstractRepository implements OnDemandInterface , AbstractRepositoryInterface {
