...
use Xtwoend\Videoplus\Tagging\Repositories\DbRepository;
use Xtwoend\Videoplus\Tagging\Tag;
...
class TagServiceProvider extends ServiceProvider {
    ...
    private function registerRepository()
    {
        ...
        {
            return new DbRepository(new \Xtwoend\Videoplus\Tagging\Models\Tag);
        });
    }
