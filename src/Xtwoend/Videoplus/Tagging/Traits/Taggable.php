<?php namespace Xtwoend\Videoplus\Tagging\Traits;

use Illuminate\Support\Str;
use Xtwoend\Videoplus\Tagging\Models\Tag;
use Xtwoend\Videoplus\Tagging\Models\Tagged;
...
trait Taggable {
	...
	public function tagged() {
		return $this->morphMany('Xtwoend\Videoplus\Tagging\Models\Tagged', 'taggable');
	}
	...
	public function scopeWithAllTags($query, $tagNames) {
		...
		$tagNames = array_map('\Xtwoend\Videoplus\Tagging\TaggingUtil::slug', $tagNames);
