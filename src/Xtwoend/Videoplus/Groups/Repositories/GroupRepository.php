<?php namespace Xtwoend\Videoplus\Groups\Repositories;
...
use Xtwoend\Videoplus\Groups\GroupInterface;


class GroupRepository extends AbstractRepository implements GroupInterface , AbstractRepositoryInterface {
